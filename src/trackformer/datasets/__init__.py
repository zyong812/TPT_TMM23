...
from .actiongenome import build_actiongenome
from .vidhoi import build_vidhoi
...
def build_dataset(split: str, args: Namespace) -> Dataset:
    ...
    elif args.dataset == 'actiongenome':
        dataset = build_actiongenome(split, args)
    elif args.dataset == 'vidhoi':
        dataset = build_vidhoi(split, args)
    else:
